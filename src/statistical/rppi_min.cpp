...
{
    host_min<Rpp8u>(static_cast<Rpp8u*>(srcPtr1), static_cast<Rpp8u*>(srcPtr2), srcSize, static_cast<Rpp8u*>(dstPtr),
                                    1);
...
int main()
{
    ...
    if (matrix == 1)
    {
        ...
        rppi_min_u8_pln1_host(srcPtr1, srcPtr2, srcSize, dstPtr);
        printf("\n\nOutput of Minimum:\n");
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput 2:\n");
            displayPlanar(srcPtr2, srcSize, channel);
            rppi_min_u8_pln3_host(srcPtr1, srcPtr2, srcSize, dstPtr);
            printf("\n\nOutput of Minimum:\n");
            displayPlanar(dstPtr, srcSize, channel);
        }
        else if (type == 2)
        {
            ...
            rppi_min_u8_pkd3_host(srcPtr1, srcPtr2, srcSize, dstPtr);
            printf("\n\nOutput of Minimum:\n");
