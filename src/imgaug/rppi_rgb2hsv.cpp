...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            ...
            rppi_rgb2hsv_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTempHSV);
        ...
        {   
            ...
            start = high_resolution_clock::now();
            rppi_rgb2hsv_u8_pkd3_host(srcPtr, srcSize, dstPtrHSV);
            stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            rppi_rgb2hsv_u8_pln3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of RGB2HSV:\n");
        ...
        else if (type == 2)
        {
            ...
            rppi_rgb2hsv_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of RGB2HSV:\n");
