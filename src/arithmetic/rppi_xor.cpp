...
int main()
{
    ...
    if (matrix == 1)
    {
        ...
        rppi_xor_u8_pln1_host(srcPtr1, srcPtr2, srcSize, dstPtr);
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput 2:\n");
            displayPlanar(srcPtr2, srcSize, channel);
            rppi_xor_u8_pln3_host(srcPtr1, srcPtr2, srcSize, dstPtr);
            printf("\n\nOutput of xor operation:\n");
            displayPlanar(dstPtr, srcSize, channel);
        }
        else if (type == 2)
        {
            ...
            rppi_xor_u8_pkd3_host(srcPtr1, srcPtr2, srcSize, dstPtr);
            printf("\n\nOutput of xor operation:\n");
