    ...
    if (input == 1)
    {
        ...
        {   if (type == 1)
            {   
                ...
                start = high_resolution_clock::now();
                rppi_exposureHSV_u8_pln3_host(srcPtrTempHSV, srcSize, dstPtrTempHSV, exposureFactor);
                stop = high_resolution_clock::now();
            ...
            {   
                ...
                start = high_resolution_clock::now();
                rppi_exposureHSV_u8_pkd3_host(srcPtrHSV, srcSize, dstPtrHSV, exposureFactor);
                stop = high_resolution_clock::now();
    ...
    else if (format == 2)
    {
        ...
        else if (matrix == 2)
        {
            ...
            if (type == 1)
            {
                ...
                rppi_exposureHSV_u8_pln3_host(srcPtr, srcSize, dstPtr, exposureFactor);
                printf("\n\nOutput of exposure Modification:\n");
            ...
            else if (type == 2)
            {
                ...
                rppi_exposureHSV_u8_pkd3_host(srcPtr, srcSize, dstPtr, exposureFactor);
                printf("\n\nOutput of exposure Modification:\n");
