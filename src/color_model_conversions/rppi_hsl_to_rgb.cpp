...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            ...
            rgb_to_hsl_host(srcPtrTemp, srcSize, dstPtrTempHSV, RPPI_CHN_PLANAR, 3);

            start = high_resolution_clock::now();
            rppi_hsl_to_rgb_u8_pln3_host(dstPtrTempHSV, dstSize, dstPtrTempRGB);
        ...
        {   
            ...
            rgb_to_hsl_host(srcPtr, srcSize, dstPtrHSV, RPPI_CHN_PACKED, 3);

            start = high_resolution_clock::now();
            rppi_hsl_to_rgb_u8_pkd3_host(dstPtrHSV, dstSize, dstPtr);
            stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            rppi_hsl_to_rgb_u8_pln3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of hsl_to_rgb:\n");
        ...
        else if (type == 2)
        {
            ...
            rppi_hsl_to_rgb_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of hsl_to_rgb:\n");
