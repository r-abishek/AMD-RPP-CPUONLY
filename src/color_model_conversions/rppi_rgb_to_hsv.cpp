...
rppi_rgb_to_hsv_u8_pln3_host(RppPtr_t srcPtr, RppiSize srcSize, RppPtr_t dstPtr)
{
    ...
    rgb_to_hsv_host<Rpp8u, Rpp32f>(static_cast<Rpp8u*>(srcPtr), srcSize, static_cast<Rpp32f*>(dstPtr),
                         RPPI_CHN_PLANAR, 3);
    return RPP_SUCCESS;
...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            ...
            rppi_rgb_to_hsv_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTempHSV);
        ...
        {   
            ...
            start = high_resolution_clock::now();
            rppi_rgb_to_hsv_u8_pkd3_host(srcPtr, srcSize, dstPtrHSV);
            stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            rppi_rgb_to_hsv_u8_pln3_host(srcPtr, srcSize, dstPtr);
        ...
        else if (type == 2)
        {
            ...
            rppi_rgb_to_hsv_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of rgb_to_hsv:\n");
