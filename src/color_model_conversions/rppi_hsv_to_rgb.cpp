...
rppi_hsv_to_rgb_u8_pln3_host(RppPtr_t srcPtr, RppiSize srcSize, RppPtr_t dstPtr)
{
    ...
    hsv_to_rgb_host<Rpp32f, Rpp8u>(static_cast<Rpp32f*>(srcPtr), srcSize, static_cast<Rpp8u*>(dstPtr),
                         RPPI_CHN_PLANAR, 3);
    return RPP_SUCCESS;
...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            ...
            rgb_to_hsv_host(srcPtrTemp, srcSize, dstPtrTempHSV, RPPI_CHN_PLANAR, 3);

            start = high_resolution_clock::now();
            rppi_hsv_to_rgb_u8_pln3_host(dstPtrTempHSV, dstSize, dstPtrTempRGB);
        ...
        {   
            ...
            rgb_to_hsv_host(srcPtr, srcSize, dstPtrHSV, RPPI_CHN_PACKED, 3);

            start = high_resolution_clock::now();
            rppi_hsv_to_rgb_u8_pkd3_host(dstPtrHSV, dstSize, dstPtr);
            stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            rppi_hsv_to_rgb_u8_pln3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of hsv_to_rgb:\n");
        ...
        else if (type == 2)
        {
            ...
            rppi_hsv_to_rgb_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of hsv_to_rgb:\n");
