...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            ...
            rppi_rgb2hsl_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTempHSV);
            stop = high_resolution_clock::now();

            hsl2rgb_host(dstPtrTempHSV, dstSize, dstPtrTempRGB, RPPI_CHN_PLANAR, 3);
        ...
        {   
            ...
            start = high_resolution_clock::now();
            rppi_rgb2hsl_u8_pkd3_host(srcPtr, srcSize, dstPtrHSV);
            stop = high_resolution_clock::now();

            hsl2rgb_host(dstPtrHSV, dstSize, dstPtr, RPPI_CHN_PACKED, 3);
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            rppi_rgb2hsl_u8_pln3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of rgb2hsl:\n");
        ...
        else if (type == 2)
        {
            ...
            rppi_rgb2hsl_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of rgb2hsl:\n");
