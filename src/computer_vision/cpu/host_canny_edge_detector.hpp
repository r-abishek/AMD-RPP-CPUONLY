                                   ...
                                   RppiChnFormat chnFormat, Rpp32u channel)
{
    ...
    T *dstPtrGreyscale = (T *)calloc(imageDim * newChannel, sizeof(T));
    ...
    Rpp32s *dstPtrIntermediateX = (Rpp32s *)calloc(imageDim * newChannel, sizeof(Rpp32s));
    ...
    Rpp32s *dstPtrIntermediateY = (Rpp32s *)calloc(imageDim * newChannel, sizeof(Rpp32s));
