...
RppStatus
rppi_sobel_filter_u8_pln1_host(RppPtr_t srcPtr, RppiSize srcSize, RppPtr_t dstPtr)
{
...
RppStatus
rppi_sobel_filter_u8_pln3_host(RppPtr_t srcPtr, RppiSize srcSize, RppPtr_t dstPtr)
{
    sobel_filter_host<Rpp8u>(static_cast<Rpp8u*>(srcPtr), srcSize, static_cast<Rpp8u*>(dstPtr),
                     RPPI_CHN_PLANAR, 3);
    return RPP_SUCCESS;
...
RppStatus
rppi_sobel_filter_u8_pkd3_host(RppPtr_t srcPtr, RppiSize srcSize, RppPtr_t dstPtr)
{
    sobel_filter_host<Rpp8u>(static_cast<Rpp8u*>(srcPtr), srcSize, static_cast<Rpp8u*>(dstPtr),
                     RPPI_CHN_PACKED, 3);
    return RPP_SUCCESS;
...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            if (channel == 1)
            {
                ...
                rppi_sobel_filter_u8_pln1_host(srcPtr, srcSize, dstPtr);
            ...
            else if (channel == 3)
            {
                ...
                start = high_resolution_clock::now();
                rppi_sobel_filter_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTemp);
                stop = high_resolution_clock::now();
        ...
        {   
            ...
            else if (channel ==3)
            {
                printf("\nExecuting pkd3...\n");
                start = high_resolution_clock::now();
                rppi_sobel_filter_u8_pkd3_host(srcPtr, srcSize, dstPtr);
                stop = high_resolution_clock::now();
    ...
    if (matrix == 1)
    {
        ...
        if (kernelSize == 3)
        {
            rppi_sobel_filter3x3_u8_pln1_host(srcPtr, srcSize, dstPtr);
        }
        else if (kernelSize == 5)
        {
            rppi_sobel_filter5x5_u8_pln1_host(srcPtr, srcSize, dstPtr);
        }
        else if (kernelSize == 7)
        {
            rppi_sobel_filter7x7_u8_pln1_host(srcPtr, srcSize, dstPtr);
        }
        */
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput:\n");
            displayPlanar(srcPtr, srcSize, channel);
            rppi_sobel_filter_u8_pln3_host(srcPtr, srcSize, dstPtr);
            /*
            if (kernelSize == 3)
            {
                rppi_sobel_filter3x3_u8_pln3_host(srcPtr, srcSize, dstPtr);
            }
            else if (kernelSize == 5)
            {
                rppi_sobel_filter5x5_u8_pln3_host(srcPtr, srcSize, dstPtr);
            }
            else if (kernelSize == 7)
            {
                rppi_sobel_filter7x7_u8_pln3_host(srcPtr, srcSize, dstPtr);
            }
            */
            printf("\n\nOutput of sobel_filter:\n");
            displayPlanar(dstPtr, srcSize, channel);
        ...
        else if (type == 2)
        {
            ...
            if (kernelSize == 3)
            {
                rppi_sobel_filter3x3_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            }
            else if (kernelSize == 5)
            {
                rppi_sobel_filter5x5_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            }
            else if (kernelSize == 7)
            {
                rppi_sobel_filter7x7_u8_pkd3_host(srcPtr, srcSize, dstPtr);
            }
            */
            printf("\n\nOutput of sobel_filter:\n");
