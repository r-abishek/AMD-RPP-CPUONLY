...
#include "cpu/host_non_max_suppression.hpp"
...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        //non_max_suppression(imageIn, imageOutOpenCV, structuringElement);
        ...
        {   
            if (channel == 1)
            {
                ...
                rppi_non_max_suppression_u8_pln1_host(srcPtr, srcSize, dstPtr, kernelSize);
            ...
            else if (channel == 3)
            {
                ...
                start = high_resolution_clock::now();
                rppi_non_max_suppression_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTemp, kernelSize);
                stop = high_resolution_clock::now();
        ...
        {   
            ...
            else if (channel ==3)
            {
                printf("\nExecuting pkd3...\n");
                start = high_resolution_clock::now();
                rppi_non_max_suppression_u8_pkd3_host(srcPtr, srcSize, dstPtr, kernelSize);
                stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput:\n");
            displayPlanar(srcPtr, srcSize, channel);
            rppi_non_max_suppression_u8_pln3_host(srcPtr, srcSize, dstPtr, kernelSize);
            printf("\n\nOutput of non_max_suppression:\n");
            displayPlanar(dstPtr, srcSize, channel);
        }
        else if (type == 2)
