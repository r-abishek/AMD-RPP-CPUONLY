                    ...
                    RppiChnFormat chnFormat, unsigned channel, RppiFormat imageFormat)
{
    ...
    else if (imageFormat == HSV)
    {
        ...
        if (chnFormat == RPPI_CHN_PLANAR)
        {
            hsv_to_rgb_host(srcPtr, srcSize, srcPtrRGB, RPPI_CHN_PLANAR, 3);
            ...
            //hsl_to_rgb_host(srcPtrHSL, srcSize, srcPtrRGB, RPPI_CHN_PLANAR, 3);

            rgb_to_hsv_host(srcPtrRGB, srcSize, dstPtr, RPPI_CHN_PLANAR, 3);
        }
        else if (chnFormat == RPPI_CHN_PACKED)
        {
            hsv_to_rgb_host(srcPtr, srcSize, srcPtrRGB, RPPI_CHN_PACKED, 3);
            ...
            //hsl_to_rgb_host(srcPtrHSL, srcSize, srcPtrRGB, RPPI_CHN_PACKED, 3);

            rgb_to_hsv_host(srcPtrRGB, srcSize, dstPtr, RPPI_CHN_PACKED, 3);
        }
    }
    */
    else
