...
#include "cpu/host_random_shadow.hpp"
...
int main(int argc, char** argv)
{
    ...
    unsigned int x1, y1, x2, y2, numberOfShadows, maxSizeX, maxSizeY;

    printf("\nEnter number of shadows: ");
    scanf("%d", &numberOfShadows);
    ...
    if (input == 1)
    {
        ...
        {   
            if (channel == 1)
            {
                ...
                rppi_random_shadow_u8_pln1_host(srcPtr, srcSize, dstPtr, x1, y1, x2, y2, numberOfShadows, maxSizeX, maxSizeY);
            ...
            else if (channel == 3)
            {
                ...
                start = high_resolution_clock::now();
                rppi_random_shadow_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTemp, x1, y1, x2, y2, numberOfShadows, maxSizeX, maxSizeY);
                stop = high_resolution_clock::now();
        ...
        {   
            ...
            else if (channel ==3)
            {
                printf("\nExecuting pkd3...\n");
                start = high_resolution_clock::now();
                rppi_random_shadow_u8_pkd3_host(srcPtr, srcSize, dstPtr, x1, y1, x2, y2, numberOfShadows, maxSizeX, maxSizeY);
                stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput:\n");
            displayPlanar(srcPtr, srcSize, channel);
            rppi_random_shadow_u8_pln3_host(srcPtr, srcSize, dstPtr, x1, y1, x2, y2, numberOfShadows, maxSizeX, maxSizeY);
            printf("\n\nOutput of random_shadow:\n");
            displayPlanar(dstPtr, srcSize, channel);
        }
        else if (type == 2)
