...
#include "cpu/host_fish_eye_effect.hpp"
...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            if (channel == 1)
            {
                ...
                rppi_fish_eye_effect_u8_pln1_host(srcPtr, srcSize, dstPtr);
            ...
            else if (channel == 3)
            {
                ...
                start = high_resolution_clock::now();
                rppi_fish_eye_effect_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTemp);
                stop = high_resolution_clock::now();
        ...
        {   
            ...
            else if (channel ==3)
            {
                printf("\nExecuting pkd3...\n");
                start = high_resolution_clock::now();
                rppi_fish_eye_effect_u8_pkd3_host(srcPtr, srcSize, dstPtr);
                stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput:\n");
            displayPlanar(srcPtr, srcSize, channel);
            rppi_fish_eye_effect_u8_pln3_host(srcPtr, srcSize, dstPtr);
            printf("\n\nOutput of fish_eye_effect:\n");
            displayPlanar(dstPtr, srcSize, channel);
        }
        else if (type == 2)
