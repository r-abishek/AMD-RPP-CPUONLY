...
#include "cpu/host_color_temperature.hpp"
...
int main(int argc, char** argv)
{
    ...
    adjustmentValue = (Rpp8s) adjustmentValueInt;
    ...
    if (input == 1)
    {
        ...
        {   
            ...
            else if (channel == 3)
            {
                ...
                start = high_resolution_clock::now();
                rppi_color_temperature_u8_pln3_host(srcPtrTemp, srcSize, dstPtrTemp, adjustmentValue);
                stop = high_resolution_clock::now();
        ...
        {   
            ...
            else if (channel ==3)
            {
                printf("\nExecuting pkd3...\n");
                start = high_resolution_clock::now();
                rppi_color_temperature_u8_pkd3_host(srcPtr, srcSize, dstPtr, adjustmentValue);
                stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput:\n");
            displayPlanar(srcPtr, srcSize, channel);
            rppi_color_temperature_u8_pln3_host(srcPtr, srcSize, dstPtr, adjustmentValue);
            printf("\n\nOutput of color_temperature:\n");
            displayPlanar(dstPtr, srcSize, channel);
        }
        else if (type == 2)
