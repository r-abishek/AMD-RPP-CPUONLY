...
int main(int argc, char** argv)
{
    ...
    if (input == 1)
    {
        ...
        {   
            if (channel == 1)
            {
                ...
                rppi_phase_u8_pln1_host(srcPtr1, srcPtr2, srcSize, dstPtr);
            ...
            else if (channel == 3)
            {
                ...
                start = high_resolution_clock::now();
                rppi_phase_u8_pln3_host(srcPtr1Temp, srcPtr2Temp, srcSize, dstPtrTemp);
                stop = high_resolution_clock::now();
        ...
        {   
            ...
            else if (channel ==3)
            {
                printf("\nExecuting pkd3...\n");
                start = high_resolution_clock::now();
                rppi_phase_u8_pkd3_host(srcPtr1, srcPtr2, srcSize, dstPtr);
                stop = high_resolution_clock::now();
    ...
    else if (matrix == 2)
    {
        ...
        if (type == 1)
        {
            ...
            printf("\n\nInput 2:\n");
            displayPlanar(srcPtr2, srcSize, channel);
            rppi_phase_u8_pln3_host(srcPtr1, srcPtr2, srcSize, dstPtr);
            printf("\n\nOutput of phaseition:\n");
            displayPlanar(dstPtr, srcSize, channel);
        }
        else if (type == 2)
